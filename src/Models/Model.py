...
from Calculator.Engine.Engine_ShapeGrid import Engine_ShapeGrid as Engine_Spacial
...
class __Model(object):
    def __init__(self):
        self.__Engine = Engine_Spacial()
    
    def updateParameters(self, params):
        if self.parameters:
            params.setTime(self.parameters.time)
            params.quasar.setPos(self.parameters.quasar.observedPosition)
            if params.galaxy.starVelocityParams and isinstance(self.__Engine,Engine_Spacial):
