...
from .peak_finding import find_peaks, prominences
...
class LightCurveSlice(LightCurve):
    ...
    def trimmed_to_size(self,size:u.Quantity):
        from mirage.light_curves.peak_finding import trimmed_to_size_slice
...
class FittingChooser(CountingChooser):
    ...
    def __init__(self,method='lorentzian'):
        ...
        if method == 'lorentzian':
            ...
            from mirage.light_curves.peak_finding import caustic_crossing
