...
engine_ptrgrid = Extension("Calculator/Engine/Engine_BruteForce", sources = ["Calculator/Engine/Engine_BruteForce.pyx"], language = "c++",    extra_compile_args=["-std=c++11","-fopenmp"], extra_link_args=["-std=c++11","-Ofast"], libraries = ["m"])
...
setup(
	ext_modules=cythonize([tree,engine,grid,ptrgrid,shapegrid,engine_grid,engine_ptrgrid,engine_shapegrid,engine_kdtree,drawer_supers,lensedimgdrawer,datavisdrawer,shapedrawer], nthreads = 8),
