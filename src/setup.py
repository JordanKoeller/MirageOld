...
setup(
	ext_modules=cythonize([tree,engine,grid,ptrgrid,shapegrid,engine_grid,engine_ptrgrid,engine_shapegrid,engine_bruteforce, engine_kdtree,drawer_supers,lensedimgdrawer,datavisdrawer,shapedrawer]),
