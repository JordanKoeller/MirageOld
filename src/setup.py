...
engine_bruteforce = Extension("Calculator/Engine/Engine_BruteForce", sources = ["Calculator/Engine/Engine_BruteForce.pyx"], language = "c++",    extra_compile_args=["-std=c++11","-fopenmp"], extra_link_args=["-std=c++11","-Ofast"], libraries = ["m"])
