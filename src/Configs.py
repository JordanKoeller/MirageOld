...
class Configs(object):
	...
	def __init__(self, dt, dTheta, canvasDim = 800,frameRate = 25, displayGalaxy = False, displayQuasar = False, colorQuasar = True, frameShift = zeroVector): #Will add more in the future as it becomes relevant.
		self.dt = dt 
		self.dTheta = dTheta
