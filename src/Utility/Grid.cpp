...
#define __PYX_HAVE__Utility__Grid
#define __PYX_HAVE_API__Utility__Grid
#include <vector>
#include "ios"
#include "new"
#include "stdexcept"
...
#define __Pyx_MODULE_NAME "Utility.Grid"
int __pyx_module_is_main_Utility__Grid = 0;

/* Implementation of 'Utility.Grid' */
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_Utility__Grid) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "Utility.Grid")) {
      if (unlikely(PyDict_SetItemString(modules, "Utility.Grid", __pyx_m) < 0)) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Utility.Grid", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init Utility.Grid");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
