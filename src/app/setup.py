...
engine_windowed = Extension("Calculator/Engine/Engine_Windowed", sources = ["Calculator/Engine/Engine_Windowed.pyx"], language = "c++",    extra_compile_args=["-std=c++11","-fopenmp"], extra_link_args=["-std=c++11","-Ofast"], libraries = ["m"])
