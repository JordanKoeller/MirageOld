...
engine_spark = Extension("Calculator/Engine/Engine_Spark", sources = ["Calculator/Engine/Engine_Spark.pyx"], language = "c++",    extra_compile_args=["-std=c++11","-fopenmp"], extra_link_args=["-std=c++11","-Ofast"], libraries = ["m"])
