...
class Dock(QtGui.QWidget, DockDrop):
    ...
    def __init__(self, name, area=None, size=(10, 10), widget=None, hideTitle=False, autoOrientation=True, closable=False,mergeSignal = NullSignal):
        QtGui.QWidget.__init__(self)
        DockDrop.__init__(self,mergeSignal = mergeSignal)
