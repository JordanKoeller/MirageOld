...
class DockDrop(object):
    ...
    def __init__(self, allowedAreas=None,mergeSignal=NullSignal):
    ...
    def dropEvent(self, ev):
        ...
        for i in self.widgets:
            if isinstance(i,LightCurvePlotView):
                for j in ev.source().widgets:
                    if isinstance(j,LightCurvePlotView):
                        self.mergeSignal.emit(i,j)
                        # self.composite = CompositeView(i,j)
