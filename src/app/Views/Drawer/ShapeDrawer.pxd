...
cpdef void drawSquare(int x0, int y0, int dim, np.ndarray[np.uint8_t, ndim=3] canvas, int color)
cdef void drawSquare_optimized(int x0, int y0, int dim, np.ndarray[np.uint8_t, ndim=3] canvas, int color, int canvasDim)